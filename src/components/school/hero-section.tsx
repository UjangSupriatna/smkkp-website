      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-20 md:py-0">
        <div className="max-w-3xl">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-6 max-w-fit"
          >
          ...
          >
            ...
            Dengan program keahlian Perhotelan, Teknik Jaringan dan Komputer
            (TKJ), dan Mekatronika. Kami mempersiapkan generasi muda untuk
          ...
          <motion.div
            ...
            className="flex sm:flex-row gap-3 sm:gap-4 mb-12"
          >
            <Button
              size="default"
              onClick={() => handleScroll("#kontak")}
              className="bg-white text-blue-800 hover:bg-blue-50 font-semibold shadow-lg hover:shadow-xl transition-all px-6 py-5 text-sm sm:text-base sm:px-8 sm:py-6"
            >
              Daftar Sekarang
            </Button>
            <Button
              ...
              className="border-2 border-white text-blue-950 hover:bg-white hover:text-blue-900 font-semibold px-6 py-5 text-sm sm:text-base sm:px-8 sm:py-6 transition-all"
            >
              Profil Sekolah
            </Button>
          </motion.div>
