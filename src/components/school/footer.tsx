...
const programLinks = [
  ...
  { label: "Teknik Jaringan dan Komputer", href: "#program" },
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-blue-100/80 max-w-xl">
                Pendaftaran peserta didik baru tahun ajaran 2026/2027 telah
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-5">
              ...
              keahlian Perhotelan dan Teknik Jaringan dan Komputer.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <p className="text-gray-500 text-sm">
              &copy; {new Date().getFullYear()} SMK Karya Permata Rancaekek.
            </p>
            <button
              onClick={scrollToTop}
